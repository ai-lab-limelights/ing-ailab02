...
### Before we start — The idea behind the Competitor from Hell

This exercise is built on the theory of **Disruptive Innovation** by Clayton Christensen (Harvard Business School).

The core idea: disruption doesn't come from building something better for existing customers. It comes from a smaller, scrappier company that enters at the bottom of the market — or creates an entirely new market — with something simpler, cheaper, or more accessible. At first, the big players ignore it. By the time they take it seriously, it's too late.
...
- Section header: [e.g. "See it in action", "How it works", "What you get"]
- Format: [choose one: step-by-step process / app walkthrough / dashboard preview / service deliverables]
- Step/Item 1: [title] — [one line description]
- Step/Item 2: [title] — [one line description]
- Step/Item 3: [title] — [one line description]
- Visual note: [what should the design agent show here? e.g. "phone mockup with app", "browser with dashboard", "process diagram"]
...
- The Product/Service Showcase must make the offering tangible — visitors should be able to picture themselves using it
